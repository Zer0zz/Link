package com.self.link.identify.adapter;
...
public class NineGridAdapter extends CommonAdapter<String> {
    ...
    private void initDeleteMenu() {
        menuView = new PopupMenuView(context, R.menu.menu_pop_del, new MenuBuilder(context));
        ...
        menuView.setOnMenuClickListener(new OptionMenuView.OnOptionMenuClickListener() {
            ...
            public boolean onOptionMenuClick(int position, OptionMenu menu) {
                ...
                if (mOnDeleteItemListener != null) {
                    mOnDeleteItemListener.onDeleted(deletePosition);
                }
    ...
    protected void convert(ViewHolder viewHolder, String item, final int position) {
        ...
        ivThum.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                if (mOnDeleteItemListener != null) {
                    mOnDeleteItemListener.onSelecting(deletePosition);
                }

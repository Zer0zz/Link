...
import com.neusoft.pictureselector.intent.PhotoPreviewIntent;
...
public class PhotoPickerActivity extends AppCompatActivity {
     ...
     * gridview添加照片位置
     */
    public static final String MORE_PHOTO = "add_photos";

    /**
     *
     */
    public static final String ADD_FRONT_IDCARD = "add_front_idcard";
    /**
     * 图片选择模式，int类型
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //已经选择了多少张照片
        selectedPictures = getIntent().getIntExtra(SELECTED_PHOTOS, 0);
...
//        startActivityForResult(intent, PhotoPreviewActivity.REQUEST_PREVIEW);
        ...
        resultList.add(path);
        data.putExtra(WHICH_POSITION,getIntent().getIntExtra(WHICH_POSITION,1));

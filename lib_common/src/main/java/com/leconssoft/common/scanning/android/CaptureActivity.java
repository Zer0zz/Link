...
import com.leconssoft.common.scanning.decode.DecodeImgCallback;
import com.leconssoft.common.scanning.decode.DecodeImgThread;
import com.leconssoft.common.scanning.decode.ImageUtil;
import com.leconssoft.common.scanning.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*先获取配置信息*/
        try {
            config = (ZxingConfig) getIntent().getExtras().get(Common.INTENT_ZXING_CONFIG);
        } catch (Exception e) {
    ...
    public void switchFlashImg(int flashState) {
        ...
        if (flashState == Common.FLASH_OPEN) {
    ...
    public void handleDecode(Result rawResult) {
        ...
        intent.putExtra(Common.CODED_CONTENT, rawResult.getText());
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.flashLightLayout) {
            ...
            startActivityForResult(intent, Common.REQUEST_IMAGE);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Common.REQUEST_IMAGE && resultCode == RESULT_OK) {

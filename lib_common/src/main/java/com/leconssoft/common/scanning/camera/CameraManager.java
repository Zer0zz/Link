...
package com.leconssoft.common.scanning.camera;
...
import com.leconssoft.common.scanning.android.CaptureActivityHandler;
...
//    }
    ...
    public void switchFlashLight(CaptureActivityHandler handler) {
        ...
        if (flashMode.equals(Camera.Parameters.FLASH_MODE_TORCH)) {
            ...
            msg.what = Common.FLASH_CLOSE;


        } else {
            /*打开闪光灯*/
            parameters.setFlashMode(Camera.Parameters.FLASH_MODE_TORCH);
            msg.what = Common.FLASH_OPEN;
        }

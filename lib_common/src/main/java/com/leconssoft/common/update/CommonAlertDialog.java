...
public class CommonAlertDialog extends Dialog implements View.OnClickListener {
	...
	private TextView bt_cancel = null, bt_ok = null,bt_middle=null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bt_ok = (TextView) findViewById(R.id.id_bt_ok);
		bt_cancel = (TextView) findViewById(R.id.id_bt_cancel);
		bt_middle = (TextView) findViewById(R.id.id_bt_middle);
	...
	public void onClick(View v) {
		...
		} else if (id == R.id.id_bt_cancel) {
			listener.onMenuClick(0);
			onBackPressed();

		} else if (id == R.id.id_bt_middle) {

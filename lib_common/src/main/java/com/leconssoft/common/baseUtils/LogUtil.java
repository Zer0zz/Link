...
public final class LogUtil {
	...
	private static final boolean LOGD_ENABLE = Common.LOGD_ENABLE;
	private static final boolean LOGE_ENABLE = Common.LOGD_ENABLE;
	private static final boolean LOGI_ENABLE = Common.LOGD_ENABLE;
	private static final boolean LOGV_ENABLE = Common.LOGD_ENABLE;
	private static final boolean LOGW_ENABLE = Common.LOGD_ENABLE;
...
//    	if(Common.LOG_SDCARD_ENABLE) fileLog(tag,msg);
    ...
    public static int w(String tag, Throwable tr) {
    	if (!LOGW_ENABLE ) return 0;
//    	if(Common.LOG_SDCARD_ENABLE) fileLog(tag,tr.getMessage());
...
//    	if(Common.LOG_SDCARD_ENABLE) fileLog(tag,msg);
    ...
    public static int e(String tag, String msg, Throwable tr) {
    	if (!LOGE_ENABLE ) return 0;
    	if(Common.LOG_SDCARD_ENABLE) fileLog(tag,msg+tr);

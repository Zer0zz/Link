package com.leconssoft.common.baseUtils.csustomdialog.dialogview;
...
import com.leconssoft.common.baseUtils.csustomdialog.dialogview.animation.Animator;
import com.leconssoft.common.baseUtils.csustomdialog.dialogview.animation.AnimatorSet;
import com.leconssoft.common.baseUtils.csustomdialog.dialogview.animation.ObjectAnimator;
import com.leconssoft.common.baseUtils.csustomdialog.dialogview.animation.PropertyValuesHolder;
import com.leconssoft.common.baseUtils.csustomdialog.dialogview.util.ScreenUtil;


/**
 * Created by liuGang on 2017/4/27.
 */
public class ProgressLoadingView extends LinearLayout {
    ...
    private String TAG = ProgressLoadingView.class.getName();
    ...
    private void init() {
        LayoutInflater.from(mContext).inflate(R.layout.progress_loading_view, this);
        dropHeight = ScreenUtil.dip2px(mContext, 50);
        view = (ProgressLoadingPath) findViewById(R.id.loading58);

...
import com.leconssoft.common.baseUtils.csustomdialog.dialogview.util.BWValueAnimator;
...
public class ProgressLoadingPath extends View {
    ...
    private int h = 0;
    private Paint paint;
    private String TAG = ProgressLoadingPath.class.getName();
    ...
    public ProgressLoadingPath(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
